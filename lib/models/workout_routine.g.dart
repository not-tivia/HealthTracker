...
class RoutineExerciseAdapter extends TypeAdapter<RoutineExercise> {
  ...
  RoutineExercise read(BinaryReader reader) {
    ...
    return RoutineExercise(
      savedExerciseId: fields[0] as String,
      order: fields[1] as int,
      overrideSets: fields[2] as int?,
      overrideMinReps: fields[3] as int?,
      overrideMaxReps: fields[4] as int?,
  ...
  void write(BinaryWriter writer, RoutineExercise obj) {
    writer
      ...
      ..write(obj.order)
      ..writeByte(2)
      ..write(obj.overrideSets)
      ..writeByte(3)
      ..write(obj.overrideMinReps)
      ..writeByte(4)
      ..write(obj.overrideMaxReps)
      ..writeByte(5)
      ..write(obj.notes);
  }
