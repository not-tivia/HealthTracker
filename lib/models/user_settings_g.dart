...
class UserSettingsAdapter extends TypeAdapter<UserSettings> {
  ...
  UserSettings read(BinaryReader reader) {
    ...
    return UserSettings(
      weeklyWorkoutGoal: fields[0] as int? ?? 4,
      dailyCalorieGoal: fields[1] as int? ?? 2000,
      dailyProteinGoal: fields[2] as int? ?? 150,
      dailyCarbsGoal: fields[3] as int? ?? 200,
      dailyFatsGoal: fields[4] as int? ?? 65,
      dailyStepGoal: fields[5] as int? ?? 10000,
      weightUnit: fields[6] as String? ?? 'lbs',
      useMetric: fields[7] as bool? ?? false,
      useGoogleFit: fields[8] as bool? ?? true,
      notificationsEnabled: fields[9] as bool? ?? true,
      lastGoogleFitSync: fields[10] as DateTime?,
      bestStreak: fields[11] as int? ?? 0,
      ...
      dailyWaterGoalOz: fields[17] as int? ?? 92,
    );
  }
